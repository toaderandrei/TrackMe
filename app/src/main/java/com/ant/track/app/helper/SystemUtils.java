...
public class SystemUtils {
    ...
    public static String getDeviceId() {
        return Settings.Secure.getString(TrackLibApplication.getInstance().getApplicationContext().getContentResolver(),
    ...
    public static String getMacAddress() {
        WifiManager wifiMan = (WifiManager) TrackLibApplication.getInstance().getApplicationContext().getSystemService(
